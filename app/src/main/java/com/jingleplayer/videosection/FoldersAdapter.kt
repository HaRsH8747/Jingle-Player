...
import com.jingleplayer.databinding.FoldersViewBinding
...
class FoldersAdapter(private val context: Context, private var foldersList: ArrayList<Folder>) : RecyclerView.Adapter<FoldersAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.root.setOnClickListener {
            ...
            VideoActivity.videoActivity.overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left)
        }
    }
