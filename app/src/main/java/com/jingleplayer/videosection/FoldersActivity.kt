...
import com.jingleplayer.databinding.ActivityFoldersBinding
import java.io.File
...
class FoldersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentFolderVideos = getAllVideos(VideoActivity.folderList[position].id)
        binding.back.setOnClickListener { onBackPressed() }
        binding.tvFolderName.text = VideoActivity.folderList[position].folderName
