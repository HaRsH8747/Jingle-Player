...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video>, private var isFolder: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.root.setOnLongClickListener {
            ...
            val customDialog = LayoutInflater.from(context).inflate(R.layout.video_more_features2, holder.root, false)
            ...
            bindingMF.infoBtn.setOnClickListener {
                ...
                val dialogIF = MaterialAlertDialogBuilder(context,R.style.alertDialog).setView(customDialogIF)
                    .setCancelable(false)
